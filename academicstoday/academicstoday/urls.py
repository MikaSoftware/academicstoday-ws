...
urlpatterns = [
    ...
    # user's convinience.
    url(r'^login/', RedirectView.as_view(pattern_name='at_login_master', permanent=True, query_string=True)),
    url(r'^login', RedirectView.as_view(pattern_name='at_login_master', permanent=True, query_string=True)),
    url(r'^sign-in/', RedirectView.as_view(pattern_name='at_login_master', permanent=True, query_string=True)),
    url(r'^sign-in', RedirectView.as_view(pattern_name='at_login_master', permanent=True, query_string=True)),
