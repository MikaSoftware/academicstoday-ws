...
class TestFranchise(TenantTestCase):
    """
    Console:
    python manage.py test shared_foundation.tests.models.test_academy
    """
    ...
    def setUp(self):
        ...
        self.user.academy = self.tenant

    def tearDown(self):
        SharedAcademy.objects.delete_all()
        del self.c
    ...
    def test_reverse(self):
        ...
        actual_url = self.tenant.reverse('at_tenant_dashboard_master')

        # Generate the URL we expect.
        self.assertIsNotNone(settings.AT_APP_HTTP_DOMAIN) # Confirm var set.
        expected_url = "http://test." + settings.AT_APP_HTTP_DOMAIN + "/en/dashboard"
