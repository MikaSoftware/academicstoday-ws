...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        academy_does_exist = SharedAcademy.objects.filter(schema_name=schema_name).exists()
        if academy_does_exist:
        ...
        self.stdout.write(
            self.style.SUCCESS(_('Successfully setup academy.'))
        )
    ...
    def begin_processing(self, schema_name, name, alternate_name, description,
        ...
        domain.domain = settings.AT_APP_HTTP_DOMAIN
        domain.domain = tenant.schema_name + '.' + settings.AT_APP_HTTP_DOMAIN
