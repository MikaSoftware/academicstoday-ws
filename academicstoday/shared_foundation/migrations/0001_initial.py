# Generated by Django 2.0.4 on 2018-04-07 21:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(db_index=True, help_text='The unique identifier which has email plus a tenant_id number appended to it. If no tenant_id is append then this user has not been assigned anywhere.', max_length=127, unique=True, verbose_name='Identifier')),
        ...
        migrations.AddField(
            ...
            name='academy',
            field=models.ForeignKey(blank=True, help_text='The academy whom this profile belongs to.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='shared_foundation.SharedAcademy'),
        ),
        migrations.AddField(
            model_name='shareduser',
            name='groups',
